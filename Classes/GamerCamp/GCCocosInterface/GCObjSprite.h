...
public:
	...
	void SetParent( cocos2d::Node * pNewParent, int zOrder );
	...
	bool IsActionStarted(cocos2d::Action* pAction);

	void UpdateActionStatus(cocos2d::Action* pAction);

	CGCObjSprite::EActionState StopAction(cocos2d::Action* pAction);
